...
<div class="bg-slate-50 w-full h-screen">
    ...
    <div class="p-4 mt-10 w-full">
       <div class="flex items-center justify-between mb-10 ">
           <h2 class="text-2xl font-bold" >Nos Films</h2>
           <div>
               <button class="px-4 py-2 bg-black text-white rounded-md"> <a href="http://localhost/xml/restaurant"> Liste restaurant</a> </button>
               <button class="px-4 py-2 bg-black text-white rounded-md"> <a href="http://localhost/xml/film/create"> Ajouter un film</a> </button>

           </div>

       </div>
       <div class="flex flex-wrap items-center justify-center bg-white rounded-xl mt-5 px-4 py-8 gap-8">
            <?php foreach($films as $film): ?>
                <!-- <div class="w-1/6 rounded overflow-hidden shadow-lg"> -->
                <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6 rounded overflow-hidden shadow-lg mb-4">
                    ...
                    <div class="px-6 py-4">
                        <div class="font-bold text-xl mb-2"><?= $film->getTitre() ?></div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Année:</span>
                            <span class="text-sm font-medium"><?= $film->getAnnee() ?></span>
                        </div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Durée:</span>
                            <span class="text-sm font-medium"><?= $film->getDuree() ?> minutes</span>
                        </div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Réalisateur:</span>
                            <span class="text-sm font-medium"><?= $film->getRealisateur() ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">Genre:</span>
                            <span class="text-sm font-medium"><?= $film->getGenre() ?></span>
                        </div>
                    </div>
                    <div class="px-6 py-4 flex gap-2 w-full justify-end">
                        <div class="bg-slate-100 p-2 rounded">
                            <a href="http://localhost/xml/film/<?= $film->getId() ?>/show">
                        ...
                        <div class="bg-slate-100 p-2 rounded">
                            <a href="http://localhost/xml/film/<?= $film->getId() ?>/edit">
                        ...
                        <div class="bg-slate-100 p-2 rounded">
                            <a href="http://localhost/xml/film/<?= $film->getId() ?>/delete">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
